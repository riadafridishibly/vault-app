...
export function ActivateKey(arg1) {
  return window['go']['main']['DatabaseService']['ActivateKey'](arg1);
}
...
export function DeactivateKey(arg1) {
  return window['go']['main']['DatabaseService']['DeactivateKey'](arg1);
}
